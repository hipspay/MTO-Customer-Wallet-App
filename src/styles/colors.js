...
const darkModeColors = {
  ...
  whiteText: '#FFFFFF',
  whiteLabel: '#FFFFFF',
  maxButtonBackground: "#D4E7F6",
  blackAmountButton: "#FFFFFF",
  purpleDark: "#FFC400",
  secondaryTextBlack: '#ffffff',
  yellowTrasparent: '#1E2027',
};
...
const getColorsByTheme = darkMode => {
  let base = {
    appleBlue: '#1C90D9', // '14, 118, 253',
    secondaryDeep: "#683AA9",
    secondaryColor: "#896BB3",
    black: '#000000', // '0, 0, 0'
  ...
  let gradients = {
    ...
    chartButtonGrey: ["#C4C4C4", "#C4C4C4"],
    lightestGrey: ['#FFFFFF', '#F2F4F7'],
    secondaryButtonLight: ['#EAE4F1', '#EAE4F1'],
  ...
  if (darkMode) {
    ...
    gradients = {
      ...
      secondaryButton: ['#404656', buildRgba('#404656', 0.8)],
    };
