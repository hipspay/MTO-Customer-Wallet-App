...
import WalletButtonIcon from '../assets/wallet-button.png'
import {
  ExchangeFab,
  FabWrapper,
  RegisterEnsFab,
...
export default function WalletScreen() {
  ...
  return (
    <WalletPage testID="wallet-screen" style={styles.walletScreen}>
      ...
      >
        <HeaderOpacityToggler isVisible={isCoinListEdited}>
          ...
          <TouchableOpacity onPress={onPress}>
            <Image source={WalletButtonIcon} style={styles.appIcon}/>
          </TouchableOpacity>
