...
import MarketPlace from '../marketplace/home';
import MarketPlaceAppBar from '../marketplace/components/marketplace_action';
import { MarketPlaceProfileScreen } from '../marketplace/profile';
import { ProfileActionButton } from '../marketplace/components/profile_action';
import { ProductDetails } from '../marketplace/product_details';
import { PurchasedProductDetails } from '../marketplace/purchasedproduct_details';
import { OrderDetails } from '../marketplace/order_details';
import { DisputeDetails } from '../marketplace/dispute_details';
...
function MainNavigator() {
  ...
  return (
    ...
    >
      ...
      <Stack.Screen
        name={Routes.MY_PRODUCT_DETAILS}
        component={PurchasedProductDetails}
      />
      <Stack.Screen name={Routes.ORDER_DETAILS} component={OrderDetails} />
      <Stack.Screen name={Routes.DISPUTE_DETAILS} component={DisputeDetails} />
      <Stack.Screen
